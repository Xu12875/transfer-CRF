...
from prompter import LABEL_LIST_DICT,CRFModel_Blzd_Prompter, CRFModel_Grs_Prompter,CRFModel_Hys_Prompter,CRFModel_Jws_Prompter,CRFModel_Ssjl_Prompter,CRFModel_Xbs_Prompter,CRFModel_Yxjc_Prompter,CRFModel_Zkjc_Prompter
from utils import load_alpaca_data, load_config, process_prompt_to_client, save_alpaca_data


def transfer_inference(inference_client_cls: Union[Type[local_inference_client], Type[online_inference_client]], 
                       prompter_cls: Union[Type[CRFModel_Blzd_Prompter], Type[CRFModel_Grs_Prompter], Type[CRFModel_Hys_Prompter]], 
                       text_type: str,
                       label_list_dicts: Dict[str, Any],
                       prompter_logger: CustomLogger,
                       client_logger: CustomLogger,
                       inference_logger: CustomLogger,
                       config_file_path: str) -> List[Dict[str, Any]]:
    ## load config
